...
class Autentifikasi extends CI_Controller
{
    ...
    public function registrasi()
    {
        ...
        //membuat rule untuk inputan password agar tidak boleh kosong, tidak ada spasi, tidak boleh kurang dari //dari 3 digit, dan password harus sama dengan repeat password dengan membuat pesan error dengan bahasa sendiri yaitu jika password password dan repeat password tidak diinput sama, maka pesannya 'Password Tidak Sama'. jika password diisi kurang dari 3 digit, maka pesannya adalah 'Password Terlalu Pendek'. 
